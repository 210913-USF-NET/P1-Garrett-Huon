...
namespace UI
{
    public class Freight : IMenu
    {
        ...
        public Freight(BLI bl, ShoppesService shoppesservice)
        {
            _bl = bl;
        ...
        public void Start()
        {
            ...
            do
            {
                Console.WriteLine("Welcome to A Freight of a Good Time");
        ...
        {
            List<Model.Product> setInventory = _bl.ViewProducts("F");
